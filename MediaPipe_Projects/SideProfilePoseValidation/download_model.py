...
The repository already ships models/pose_landmarker_heavy.task, so this is only
needed if that file is missing. Swap the URL for _full or _lite for more speed.
"""
import os
